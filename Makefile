...
IMAGE:=yidansun/pstat-134-spring-2021
TAG?=latest
...
repo-structure: ## Create public/private repository pair 
	git remote add private-repo https://github.com/edensunyidan/pstat-134-spring-2021-private
	git remote add public-repo https://github.com/edensunyidan/pstat-134-spring-2021
